        ...
        <View style={{flex: 1, backgroundColor: Color.orangeClarito}}>
            ...
            <View style={{flex: 1, justifyContent: "center", alignItems: "center"}}>
                <View style={[styles.containerAnimal]}>
                    <Image source={require('../assets/images/CATALOGO_DE_ADOPCIONES/Eros.png')} style={styles.imgAnimal}/>
                   
                    <View style={{flexDirection: "row"}}>
                        <View style={{flexDirection: "column"}}>
                            <Text style={styles.textoNombreAnimal}>Eros</Text>
                            <View style={{flexDirection: "row"}}>
                    ...
                    <View style={{flexDirection:"row", justifyContent:"center"}}>
                        ...
                        <View style={styles.containerAnimalData}>
                            ...
                            <Text style={styles.textoDatosAnimal}>6 meses</Text>
                        </View>
                        <View style={styles.containerAnimalData}>
                    ...
                    <Text style={[styles.textoInfoAnimal]}>Eros entró de forma inesperada a una peluquería en la que justo estaba uno de nuestros voluntarios, no llevaba chip y nadie lo ha reclamado así que busca familia definitiva.</Text>
