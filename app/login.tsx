...
<View style={[GlobalStyles.containerUserLogin, {position: "relative"}, {paddingTop: 300}]}>
  ...
  <View>
      <Image source={require('../assets/images/PAGINA_REGISTRO_E_INICIO_DE_SESION/perrito.png')} style={[GlobalStyles.imgAnimalesInicioyRegistro, {top:-300}, {height:300}, {width: 300}, {left:100}]}/>
  </View>
  ...
  <Text style={GlobalStyles.textoAccederRefugio}>Accede al refugio</Text>
  <TextInput placeholder="Email" style={GlobalStyles.textInputs}/>
  <TextInput placeholder="Contraseña" style={GlobalStyles.textInputs} secureTextEntry={true}/>

  <View style={[GlobalStyles.containerButton, {justifyContent: "space-between"}]}>
      <Pressable onPress={()=> router.push('./mainpage')
      }  style={GlobalStyles.botones}><Text style={{color: Color.superWhite, fontSize: 30, paddingBottom: 5, fontFamily: "PoppinsBold"}}>Acceder</Text></Pressable>
      <Pressable onPress={()=> router.push('./register')
      } style={GlobalStyles.botones}><Text style={{color: Color.superWhite, fontSize: 30, paddingBottom: 5, fontFamily: "PoppinsBold"}}>Registrarse</Text></Pressable>
  </View>
</View>
