        ...
        <View style={{flex: 1, backgroundColor: Color.orangeClarito}}>
            ...
            <View style={{flex: 1, justifyContent: "center", alignItems: "center"}}>
                <View style={[styles.containerAnimal]}>
                    <Image source={require('../assets/images/CATALOGO_DE_ADOPCIONES/Afro_y_Shaggy.png')} style={styles.imgAnimal}/>
                   
                    <View style={{flexDirection: "row"}}>
                        <View style={{flexDirection: "column"}}>
                            <Text style={styles.textoNombreAnimal}>Afro y Shaggy</Text>
                            <View style={{flexDirection: "row"}}>
                        ...
                        <Image source={require('../assets/images/ELEMENTOS_GENERALES/fav_icon.png')} style={[styles.imgFav, {marginLeft: 143}]}/>
                    </View>

                    <View style={{flexDirection:"row", justifyContent:"center"}}>
                        <View style={styles.containerAnimalData}>
                            <Text style={styles.textoCategoriaDatos}>Sexo</Text>
                            <Text style={styles.textoDatosAnimal}>Machos</Text>
                        </View>
                        <View style={styles.containerAnimalData}>
                            <Text style={styles.textoCategoriaDatos}>Edad</Text>
                            <Text style={styles.textoDatosAnimal}>3 meses</Text>
                        </View>
                        <View style={styles.containerAnimalData}>
                            <Text style={styles.textoCategoriaDatos}>Tipo</Text>
                            <Text style={styles.textoDatosAnimal}>Nose</Text>
                        </View>
                    </View>
                    ...
                    <Text style={[styles.textoInfoAnimal]}>Afro entró de forma inesperada a una peluquería en la que justo estaba uno de nuestros voluntarios, no llevaba chip y nadie lo ha reclamado así que busca familia definitiva.</Text>
