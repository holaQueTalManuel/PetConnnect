        ...
        <View style={{flex: 1, backgroundColor: Color.orangeClarito}}>
            ...
            <View style={{flex: 1, justifyContent: "center", alignItems: "center"}}>
                <View style={GlobalStyles.containerAnimal}>
                    <Image source={require('../assets/images/CATALOGO_DE_ADOPCIONES/Afro_y_Shaggy.png')} style={GlobalStyles.imgAnimal}/>
                   
                    <View style={{flexDirection: "row"}}>
                        <View style={{flexDirection: "column"}}>
                            <Text style={GlobalStyles.textoNombreAnimal}>Afro y Shaggy</Text>
                            <View style={{flexDirection: "row"}}>
                        ...
                        <Image source={require('../assets/images/ELEMENTOS_GENERALES/fav_icon.png')} style={[GlobalStyles.imgFav, {marginLeft: 143}]}/>
                    </View>

                    <View style={{flexDirection:"row", justifyContent:"center"}}>
                        <View style={GlobalStyles.containerAnimalData}>
                            <Text style={GlobalStyles.textoCategoriaDatos}>Sexo</Text>
                            <Text style={GlobalStyles.textoDatosAnimal}>Machos</Text>
                        </View>
                        <View style={GlobalStyles.containerAnimalData}>
                            <Text style={GlobalStyles.textoCategoriaDatos}>Edad</Text>
                            <Text style={GlobalStyles.textoDatosAnimal}>3 meses</Text>
                        </View>
                        <View style={GlobalStyles.containerAnimalData}>
                            <Text style={GlobalStyles.textoCategoriaDatos}>Tipo</Text>
                            <Text style={GlobalStyles.textoDatosAnimal}>Nose</Text>
                        </View>
                    </View>
                    ...
                    <Text style={[GlobalStyles.textoInfoAnimal]}>Afro entró de forma inesperada a una peluquería en la que justo estaba uno de nuestros voluntarios, no llevaba chip y nadie lo ha reclamado así que busca familia definitiva.</Text>
