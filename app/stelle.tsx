        ...
        <View style={{flex: 1, backgroundColor: Color.orangeClarito}}>
            ...
            <View style={{flex: 1, justifyContent: "center", alignItems: "center"}}>
                <View style={GlobalStyles.containerAnimal}>
                    <Image source={require('../assets/images/CATALOGO_DE_ADOPCIONES/Stelle.png')} style={GlobalStyles.imgAnimal}/>
                   
                    <View style={{flexDirection: "row"}}>
                        <View style={{flexDirection: "column"}}>
                            <Text style={GlobalStyles.textoNombreAnimal}>Stelle</Text>
                            <View style={{flexDirection: "row"}}>
                    ...
                    <View style={{flexDirection:"row", justifyContent:"center"}}>
                        <View style={GlobalStyles.containerAnimalData}>
                            ...
                            <Text style={GlobalStyles.textoDatosAnimal}>Hembra</Text>
                        </View>
                        <View style={GlobalStyles.containerAnimalData}>
                            <Text style={GlobalStyles.textoCategoriaDatos}>Edad</Text>
                            <Text style={GlobalStyles.textoDatosAnimal}>2 años</Text>
                        </View>
                        <View style={GlobalStyles.containerAnimalData}>
                    ...
                    <Text style={[GlobalStyles.textoInfoAnimal]}>Stelle entró de forma inesperada a una peluquería en la que justo estaba uno de nuestros voluntarios, no llevaba chip y nadie lo ha reclamado así que busca familia definitiva.</Text>
