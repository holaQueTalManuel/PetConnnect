        ...
        <View style={{flex: 1, backgroundColor: Color.orangeClarito}}>
            ...
            <View style={{flex: 1, justifyContent: "center", alignItems: "center"}}>
                <View style={[styles.containerAnimal]}>
                    <Image source={require('../assets/images/CATALOGO_DE_ADOPCIONES/Stelle.png')} style={styles.imgAnimal}/>
                   
                    <View style={{flexDirection: "row"}}>
                        <View style={{flexDirection: "column"}}>
                            <Text style={styles.textoNombreAnimal}>Stelle</Text>
                            <View style={{flexDirection: "row"}}>
                    ...
                    <View style={{flexDirection:"row", justifyContent:"center"}}>
                        <View style={styles.containerAnimalData}>
                            ...
                            <Text style={styles.textoDatosAnimal}>Hembra</Text>
                        </View>
                        <View style={styles.containerAnimalData}>
                            <Text style={styles.textoCategoriaDatos}>Edad</Text>
                            <Text style={styles.textoDatosAnimal}>2 años</Text>
                        </View>
                        <View style={styles.containerAnimalData}>
                    ...
                    <Text style={[styles.textoInfoAnimal]}>Stelle entró de forma inesperada a una peluquería en la que justo estaba uno de nuestros voluntarios, no llevaba chip y nadie lo ha reclamado así que busca familia definitiva.</Text>
